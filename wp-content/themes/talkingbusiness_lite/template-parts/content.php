...
<?php $size = talkingbusiness_lite_post_thumbnail_size( array( 'class_prefix' => 'post-thumbnail--' ) ); ?>
	...
	<div class="post-list__item-content">
		...
		<?php if ( 'post' === get_post_type() ) : ?>
			...
			<div class="entry-meta">
				...
				<?php $tags_visible = talkingbusiness_lite_is_meta_visible( 'blog_post_tags', 'loop' ) ? 'true' : 'false';
					if ( $tags_visible === 'true' ) {
						$utility->meta_data->get_terms( array(
							'type'      => 'post_tag',
							'delimiter' => ', ',
							'before'    => '<span class="post__tags"><span class="post__tags-label">' . esc_html__( 'Tags:', 'talkingbusiness_lite' ) . '</span>',
							'after'     => '</span>',
							'echo'      => true,
						) );
					}
		...
		<div class="entry-content">
			<?php $blog_content = get_theme_mod( 'blog_posts_content', talkingbusiness_lite_theme()->customizer->get_default( 'blog_posts_content' ) );
