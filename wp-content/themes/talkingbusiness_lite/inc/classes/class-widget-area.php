...
if ( ! class_exists( 'TalkingBusiness_Lite_Widget_Area' ) ) {

	class TalkingBusiness_Lite_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'talkingbusiness_lite_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'talkingbusiness_lite_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'talkingbusiness_lite_widget_area_classes', $classes, $area_id );
	...
	function talkingbusiness_lite_widget_area() {
		return TalkingBusiness_Lite_Widget_Area::get_instance();
	}

	talkingbusiness_lite_widget_area();
}
