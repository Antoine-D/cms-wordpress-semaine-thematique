<?php
/**
 * About TalkingBusiness_Lite widget.
 *
 * @package TalkingBusiness_Lite
 */

if ( ! class_exists( 'TalkingBusiness_Lite_About_Widget' ) ) {

	class TalkingBusiness_Lite_About_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display an information about your site.', 'talkingbusiness_lite' );
			$this->widget_id          = 'talkingbusiness_lite_widget_about';
			$this->widget_name        = esc_html__( 'About TalkingBusiness_Lite', 'talkingbusiness_lite' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'value' => '',
				...
				'media_id' => array(
					...
					'value'              => '',
					'label'              => esc_html__( 'Logo:', 'talkingbusiness_lite' ),
				),
				'enable_tagline' => array(
					...
					'options' => array(
						'enable_tagline' => esc_html__( 'Enable Tagline:', 'talkingbusiness_lite' ),
					),
				),
				'content'  => array(
					'type'              => 'textarea',
					'placeholder'       => esc_html__( 'Text or HTML', 'talkingbusiness_lite' ),
					'value'             => '',
		...
		public function widget( $args, $instance ) {
			...
			if ( $tagline_enabled ) {
				$format   = apply_filters( 'talkingbusiness_lite_about_widget_tagline_format', '<p>%s</p>', $this->settings, $this->args );
...
add_action( 'widgets_init', 'talkingbusiness_lite_register_about_widget' );
function talkingbusiness_lite_register_about_widget() {
	register_widget( 'TalkingBusiness_Lite_About_Widget' );
}
