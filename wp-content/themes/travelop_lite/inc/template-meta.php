 ...
 * @return void
 */
function travelop_lite_meta_author( $context = 'loop', $args = array() ) {
	...
	if ( ! travelop_lite_is_meta_visible( $meta, $context ) ) {
		return;
	}
	...
	$author_format = apply_filters(
		'travelop_lite_meta_author_format',
 ...
 * @return void
 */
function travelop_lite_meta_date( $context = 'loop', $args = array() ) {
	...
	$date_format = apply_filters(
		'travelop_lite_meta_date_format',
 ...
 * @return void
 */
function travelop_lite_meta_comments( $context = 'loop', $args = array() ) {
	...
	$comments_format = apply_filters(
		'travelop_lite_meta_comments_format',
 ...
 * @return void
 */
function travelop_lite_meta_categories( $context = 'loop', $args = array(), $echo = true ) {
	...
	$categories_format = apply_filters(
		'travelop_lite_meta_categories_format',
 ...
 * @return void
 */
function travelop_lite_meta_tags( $context = 'loop', $args = array() ) {
	...
	$tags_format = apply_filters(
		'travelop_lite_meta_tags_format',
 ...
 * @return array
 */
function travelop_lite_share_buttons( $context = 'loop', $args = array(), $config = array() ) {
	...
	$default_config = apply_filters( 'travelop_lite_default_config_share_buttons', array(
	...
	$share_item_html = apply_filters( 'travelop_lite_share_button_html',
	...
	foreach ( (array) $networks as $id => $network ) :
		...
		$share_buttons .= sprintf(
			...
			esc_html__( 'Share on ', 'travelop_lite' ) . $network['name'],
 ...
 * @return bool
 */
function travelop_lite_is_meta_visible( $meta, $context = 'loop' ) {

	if ( ! $meta ) {
		return false;
	}

	$meta_enabled = get_theme_mod( $meta, travelop_lite_theme()->customizer->get_default( $meta ) );
