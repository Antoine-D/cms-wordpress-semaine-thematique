...
if ( ! class_exists( 'Travelop_lite_Widget_Area' ) ) {

	class Travelop_lite_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'travelop_lite_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'travelop_lite_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'travelop_lite_widget_area_classes', $classes, $area_id );
	...
	function travelop_lite_widget_area() {
		return Travelop_lite_Widget_Area::get_instance();
	}

	travelop_lite_widget_area();
}
