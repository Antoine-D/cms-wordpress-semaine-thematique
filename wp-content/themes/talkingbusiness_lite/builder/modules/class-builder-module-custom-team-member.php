...
class TM_Builder_Module_Custom_Team_Member extends TM_Builder_Module {
	...
	function init() {
		...
		$this->name             = esc_html__( 'Custom Team', 'talkingbusiness_lite' );
		$this->icon             = 'f183';
		...
		$this->custom_css_options = array(
			'member_image' => array(
				'label'    => esc_html__( 'Member Image', 'talkingbusiness_lite' ),
				'selector' => '.tm_pb_team_member_image',
			),
			'member_description' => array(
				'label'    => esc_html__( 'Member Description', 'talkingbusiness_lite' ),
			...
			'member_position' => array(
				'label'    => esc_html__( 'Member Position', 'talkingbusiness_lite' ),
				'selector' => '.tm_pb_member_position h6',
			),
			'member_social_links' => array(
				'label'    => esc_html__( 'Member Social Links', 'talkingbusiness_lite' ),
	...
	function get_fields() {
		...
		$fields_top = array(
			'name' => array(
				'label'           => esc_html__( 'Name', 'talkingbusiness_lite' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Input the name of the person', 'talkingbusiness_lite' ),
			),
			'position' => array(
				'label'           => esc_html__( 'Position', 'talkingbusiness_lite' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( "Input the person's position.", 'talkingbusiness_lite' ),
			),
			'custom_url' => array(
				'label'           => esc_html__( 'Custom URL', 'talkingbusiness_lite' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( "Custom URL to the person's page.", 'talkingbusiness_lite' ),
			),
			'image_url' => array(
				'label'              => esc_html__( 'Image URL', 'talkingbusiness_lite' ),
				'type'               => 'upload',
				'option_category'    => 'basic_option',
				...
				'description'        => esc_html__( 'Upload your desired image, or type in the URL to the image you would like to display.', 'talkingbusiness_lite' ),
			),
			'image_position' => array(
				'label'           => esc_html__( 'Image postion', 'talkingbusiness_lite' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'0'   => esc_html__( 'Top', 'talkingbusiness_lite' ),
					'2'  =>  esc_html__( 'Bottom', 'talkingbusiness_lite' ),
				),
				'description'     => esc_html__( 'Here you can define the alignemnt of image', 'talkingbusiness_lite' ),
			),
			'animation' => array(
				'label'             => esc_html__( 'Animation', 'talkingbusiness_lite' ),
				'type'              => 'select',
				'option_category'   => 'configuration',
				'options'           => array(
					'off'     => esc_html__( 'No Animation', 'talkingbusiness_lite' ),
					'fade_in' => esc_html__( 'Fade In', 'talkingbusiness_lite' ),
					'left'    => esc_html__( 'Left To Right', 'talkingbusiness_lite' ),
					'right'   => esc_html__( 'Right To Left', 'talkingbusiness_lite' ),
					'top'     => esc_html__( 'Top To Bottom', 'talkingbusiness_lite' ),
					'bottom'  => esc_html__( 'Bottom To Top', 'talkingbusiness_lite' ),
				),
				'description'       => esc_html__( 'This controls the direction of the lazy-loading animation.', 'talkingbusiness_lite' ),
			),
			'text_alignment' => array(
				'label'           => esc_html__( 'Text alignment', 'talkingbusiness_lite' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
				...
				'description'     => esc_html__( 'Here you can define the alignemnt of text', 'talkingbusiness_lite' ),
			),
			'background_layout' => array(
				'label'           => esc_html__( 'Text Color', 'talkingbusiness_lite' ),
				'type'            => 'select',
				'option_category' => 'color_option',
				'options'           => array(
					'light' => esc_html__( 'Dark', 'talkingbusiness_lite' ),
					'dark'  => esc_html__( 'Light', 'talkingbusiness_lite' ),
				),
				'description' => esc_html__( 'Here you can choose the value of your text. If you are working with a dark background, then your text should be set to light. If you are working with a light background, then your text should be dark.', 'talkingbusiness_lite' ),
			),
		);
		...
		foreach ( $this->get_socials() as $net => $data ) {
			$fields_social[ $net . '_url' ] = array(
				'label'           => sprintf( esc_html__( '%s Profile Url', 'talkingbusiness_lite' ), $data['label'] ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => sprintf( esc_html__( 'Input %s Profile Url.', 'talkingbusiness_lite' ), $data['label'] ),
			);
		}

		$fields_bottom = array(
			'content_new' => array(
				'label'           => esc_html__( 'Description', 'talkingbusiness_lite' ),
				'type'            => 'tiny_mce',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Input the main text content for your module here.', 'talkingbusiness_lite' ),
			),
			'icon_color' => array(
				'label'             => esc_html__( 'Icon Color', 'talkingbusiness_lite' ),
				'type'              => 'color',
				'custom_color'      => true,
				'tab_slug'          => 'advanced',
			),
			'icon_hover_color' => array(
				'label'             => esc_html__( 'Icon Hover Color', 'talkingbusiness_lite' ),
				'type'              => 'color',
				'custom_color'      => true,
				'tab_slug'          => 'advanced',
			),
	...
	public function get_socials() {
		...
		self::$socials = apply_filters(
			...
			array(
				'facebook' => array(
					'label' => esc_html__( 'Facebook', 'talkingbusiness_lite' ),
					'icon'  => 'f09a',
				),
				'twitter'  => array(
					'label' => esc_html__( 'Twitter', 'talkingbusiness_lite' ),
					'icon'  => 'f099',
				),
				'google'   => array(
					'label' => esc_html__( 'Google+', 'talkingbusiness_lite' ),
					'icon'  => 'f0d5',
				),
				'linkedin' => array(
					'label' => esc_html__( 'LinkedIn', 'talkingbusiness_lite' ),
					'icon'  => 'f0e1',
				),
			)
		);
