...
if ( ! class_exists( 'Travelop_lite_Custom_Posts_Widget' ) ) {

	class Travelop_lite_Custom_Posts_Widget extends Cherry_Abstract_Widget {
		/**
		 * Constructor
		 *
		 * @since  1.0.0
		...
		public function __construct() {
			...
			$this->widget_name = esc_html__( 'Custom Posts', 'travelop_lite' );
			$this->widget_description = esc_html__( 'Display custom posts your site.', 'travelop_lite' );
			$this->widget_id = apply_filters( 'travelop_lite_custom_posts_widget_ID', 'widget-custom-postson' );
			$this->widget_cssclass = apply_filters( 'travelop_lite_custom_posts_widget_cssclass', 'widget-custom-postson' );

			$this->settings = array(
				'title' => array(
					'type'				=> 'text',
					'value'				=> esc_html__( 'Custom Posts', 'travelop_lite' ),
				...
				'terms_type' => array(
					...
					'options'			=> array(
						...
						'post_format'	=> array(
							'label'		=> esc_html__( 'Post Format', 'travelop_lite' ),
				...
				'post_format' => array(
					...
					'options'			=> false,
					'label'				=> esc_html__( 'Select post format', 'travelop_lite' ),
					'multiple'			=> true,
					'placeholder'		=> esc_html__( 'Select post format', 'travelop_lite' ),
				...
				'posts_per_page' => array(
					...
					'max_value'			=> 50,
					'min_value'			=> 0,
					'label'				=> esc_html__( 'Posts count ( Set 0 to show all. )', 'travelop_lite' ),
				),
				'post_offset' => array(
					'type'				=> 'stepper',
					'value'				=> '0',
					...
					'min_value'			=> '0',
					'step_value'		=> '1',
					'label'				=> esc_html__( 'Offset post', 'travelop_lite' ),
				),
				'show_thumb'     => array(
					'type'  => 'switcher',
					'value' => 'true',
				...
				'title_length' => array(
					...
					'min_value'			=> '0',
					'step_value'		=> '1',
					'label'				=> esc_html__( 'Title words length ( Set 0 to hide title. )', 'travelop_lite' ),
				),
				'excerpt_length' => array(
					...
					'min_value'			=> '0',
					'step_value'		=> '1',
					'label'				=> esc_html__( 'Excerpt words length ( Set 0 to hide excerpt. )', 'travelop_lite' ),
				),
				'mate_data' => array(
					'type'				=> 'checkbox',
					'value'				=> array(
					...
					'options'				=> array(
						'date'				=> esc_html__( 'Date', 'travelop_lite' ),
						'author'			=> esc_html__( 'Author', 'travelop_lite' ),
						'comment_count'		=> esc_html__( 'Comment count', 'travelop_lite' ),
						'category'			=> esc_html__( 'Category', 'travelop_lite' ),
						'post_tag'			=> esc_html__( 'Tag', 'travelop_lite' ),
						'more_button'		=> esc_html__( 'More Button', 'travelop_lite' ),
					),
					'label'				=> esc_html__( 'Display post meta data', 'travelop_lite' ),
				),
				'button_text' => array(
					'type'				=> 'text',
					'value'				=> 'Read More',
					'label'				=> esc_html__( 'Post read more button label', 'travelop_lite' ),
				),
			);
	...
	add_action( 'widgets_init', 'travelop_lite_register_custom_posts_widget' );
	function travelop_lite_register_custom_posts_widget() {
		register_widget( 'Travelop_lite_Custom_Posts_Widget' );
	}
}