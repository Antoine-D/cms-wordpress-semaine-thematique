...
if ( ! class_exists( 'Travelop_lite_Smart_Slider_Widget' ) ) {

	class Travelop_lite_Smart_Slider_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_cssclass    = 'travelop_lite widget_smart_slider';
			$this->widget_description = esc_html__( 'Display smart slider on your site.', 'travelop_lite' );
			$this->widget_id          = 'widget_smart_slider';
			$this->widget_name        = esc_html__( 'Smart Slider', 'travelop_lite' );
			$this->settings           = array(
				'title' => array(
					'type'				=> 'text',
					'value'				=> esc_html__( 'Smart Slider', 'travelop_lite' ),
				...
				'terms_type' => array(
					...
					'options' => array(
						'category' => array(
							'label'		=> esc_html__( 'Category', 'travelop_lite' ),
							'slave'		=> 'terms_type_category',
						),
						'post_tag' => array(
							'label'		=> esc_html__( 'Tag', 'travelop_lite' ),
							'slave'		=> 'terms_type_post_tag',
						),
					),
					'label'				=> esc_html__( 'Choose taxonomy type', 'travelop_lite' ),
				),
				'categories' => array(
					'type'				=> 'select',
					'size'				=> 1,
					...
					'options'			=> false,
					'label'				=> esc_html__( 'Select category', 'travelop_lite' ),
					'multiple'			=> true,
					'placeholder'		=> esc_html__( 'Select category', 'travelop_lite' ),
				...
				'tags' => array(
					...
					'options'			=> false,
					'label'				=> esc_html__( 'Select tags', 'travelop_lite' ),
					'multiple'			=> true,
					'placeholder'		=> esc_html__( 'Select tags', 'travelop_lite' ),
				...
				'posts_per_page' => array(
					...
					'max_value'			=> 50,
					'min_value'			=> 1,
					'label'				=> esc_html__( 'Posts count', 'travelop_lite' ),
				),
				'post_title' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display title', 'travelop_lite' ),
				),
				'content' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display content', 'travelop_lite' ),
				),
				'more_button' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display more button', 'travelop_lite' ),
					'toggle' => array(
						'true_toggle'	=> esc_html__( 'On', 'travelop_lite' ),
						'false_toggle'	=> esc_html__( 'Off', 'travelop_lite' ),
				...
				'more_button_text' => array(
					...
					'label'				=> esc_html__( 'More button text', 'travelop_lite' ),
				...
				'trim_words' => array(
					...
					'min_value'			=> 1,
					'step_value'		=> 1,
					'label'				=> esc_html__( 'Content words trimmed count', 'travelop_lite' ),
				),
				'width' => array(
					'type'				=> 'text',
					'value'				=> '100%',
					'label'				=> esc_html__( 'Slider width', 'travelop_lite' ),
				),
				'height' => array(
					'type'				=> 'text',
					'value'				=> '800',
					'label'				=> esc_html__( 'Slider height', 'travelop_lite' ),
				),
				'orientation' => array(
					'type'				=> 'select',
					'size'				=> 1,
					'value'				=> 'horizontal',
					'options' => array(
						'horizontal'	=> esc_html__( 'Horizontal', 'travelop_lite' ),
						'vertical'		=> esc_html__( 'Vertical', 'travelop_lite' ),
					),
					'label'				=> esc_html__( 'Slider orientation', 'travelop_lite' ),
				),
				'slide_distance' => array(
					...
					'max_value'			=> 100,
					'min_value'			=> 0,
					'label'				=> esc_html__( 'Slide distance(px)', 'travelop_lite' ),
				),
				'slide_duration' => array(
					...
					'min_value'			=> 100,
					'step_value'		=> 100,
					'label'				=> esc_html__( 'Slide duration(ms)', 'travelop_lite' ),
				),
				'slide_fade' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use fade effect?', 'travelop_lite' ),
				),
				'navigation' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use navigation?', 'travelop_lite' ),
					'toggle' => array(
						'true_toggle'	=> esc_html__( 'On', 'travelop_lite' ),
						'false_toggle'	=> esc_html__( 'Off', 'travelop_lite' ),
				...
				'fade_navigation' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Indicates whether the arrows will fade in only on hover', 'travelop_lite' ),
				...
				'pagination' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use pagination?', 'travelop_lite' ),
				),
				'autoplay' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use autoplay?', 'travelop_lite' ),
				),
				'fullScreen' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display fullScreen button?', 'travelop_lite' ),
				),
				'shuffle' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Indicates if the slides will be shuffled', 'travelop_lite' ),
				),
				'loop' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use infinite scrolling?', 'travelop_lite' ),
				),
				'thumbnails' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display thumbnails?', 'travelop_lite' ),
					'toggle'			=> array(
						'true_toggle'	=> esc_html__( 'On', 'travelop_lite' ),
						'false_toggle'	=> esc_html__( 'Off', 'travelop_lite' ),
				...
				'thumbnails_position' => array(
					...
					'value'				=> 'bottom',
					'options' => array(
						'bottom'		=> esc_html__( 'Bottom', 'travelop_lite' ),
					),
					'label'				=> esc_html__( 'Sets the position of the thumbnail scroller', 'travelop_lite' ),
				...
				'thumbnails_arrows' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display thumbnails arrows?', 'travelop_lite' ),
					'master'			=> 'thumbnails_attr',
				),
			);
		...
		public function widget( $args, $instance ) {
			...
			if ( $posts_query ) {
				...
				$html = '<h4>' . esc_html__( 'Posts for slider not found', 'travelop_lite' ) . '</h4>';
			}
		...
		public function render_slider( $posts_query ) {
			...
			$html = '<div class="travelop_lite-smartslider" ' . $slider_html_attr . '>';
				$html .= '<div id="' . $uniq_id . '" class="travelop_lite-smartslider__instance slider-pro">';
					$html .= '<div class="travelop_lite-smartslider__slides sp-slides">';
						$html .= $this->get_slider_loop( $posts_query );
					$html .= '</div>';

					if ( 'true' == $this->instance['thumbnails'] ) {
						$html .= '<div class="travelop_lite-smartslider__thumbnails sp-thumbnails">';
		...
		public function get_query_slider_items( $query_args = array() ) {
			...
			$defaults_query_args = apply_filters( 'travelop_lite_smart_slider_default_query_args', array(
				'post_type'				=> 'post',
				'orderby'				=> 'date',
				'order'					=> 'DESC',
				'posts_per_page'		=> -1,
		...
		public function get_slider_loop( $posts_query ) {
			 ...
			 * @var  array
			 */
			$title_settings = apply_filters( 'travelop_lite_smart_slider_title_settings', array(
				//'width'				=> '100%%',
				'horizontal'		=> '0%%',
				'vertical'			=> '0%%',
			 ...
			 * @var  array
			 */
			$content_settings = apply_filters( 'travelop_lite_smart_slider_content_settings', array(
				//'width'				=> '90%%',
				'horizontal'		=> '0%%',
				'vertical'			=> '0%%',
				'show_transition'	=> 'left',
			 ...
			 * @var  array
			 */
			$more_settings = apply_filters( 'travelop_lite_smart_slider_more_button_settings', array(
				//'width'				=> '90%%',
				'horizontal'		=> '0%%',
				'vertical'			=> '0%%',
				'show_transition'	=> 'left',
	...
	add_action( 'widgets_init', 'travelop_lite_register_smart_slider_widgets' );
	function travelop_lite_register_smart_slider_widgets() {
		register_widget( 'Travelop_lite_Smart_Slider_Widget' );
	}
}