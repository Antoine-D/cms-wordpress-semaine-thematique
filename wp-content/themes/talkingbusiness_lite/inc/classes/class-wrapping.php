 ...
 */
add_filter( 'template_include', array( 'TalkingBusiness_Lite_Wrapping', 'wrap' ), 99 );
add_filter( 'talkingbusiness_lite_wrap_base', 'talkingbusiness_lite_wrap_base_cpts' );
 ...
 */
function talkingbusiness_lite_template_path() {
	return TalkingBusiness_Lite_Wrapping::$main_template;
}
 ...
 */
function talkingbusiness_lite_template_base() {
	return TalkingBusiness_Lite_Wrapping::$base;
}

if ( ! class_exists( 'TalkingBusiness_Lite_Wrapping' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class TalkingBusiness_Lite_Wrapping {
		...
		/**
		 * Initialize new instance of TalkingBusiness_Lite_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'talkingbusiness_lite_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in TalkingBusiness_Lite_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new TalkingBusiness_Lite_Wrapping();
		}
	}
}
 ...
 */
function talkingbusiness_lite_wrap_base_cpts( $templates ) {
