 ...
 */
add_filter( 'template_include', array( 'Travelop_lite_Wrapping', 'wrap' ), 99 );
add_filter( 'travelop_lite_wrap_base', 'travelop_lite_wrap_base_cpts' );
 ...
 */
function travelop_lite_template_path() {
	return Travelop_lite_Wrapping::$main_template;
}
 ...
 */
function travelop_lite_template_base() {
	return Travelop_lite_Wrapping::$base;
}

if ( ! class_exists( 'Travelop_lite_Wrapping' ) ) {
	...
	class Travelop_lite_Wrapping {
		...
		/**
		 * Initialize new instance of Travelop_lite_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'travelop_lite_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Travelop_lite_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new Travelop_lite_Wrapping();
		}
	}
}
 ...
 */
function travelop_lite_wrap_base_cpts( $templates ) {
