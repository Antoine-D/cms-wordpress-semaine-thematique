 ...
 * @return void
 */
function talkingbusiness_lite_main_menu() { ?>
	<nav id="site-navigation" class="main-navigation" role="navigation">
		<button class="menu-toggle" aria-controls="main-menu" aria-expanded="false">
			<i class="menu-toggle__icon fa fa-bars" aria-hidden="true"></i>
			<?php echo esc_html__( 'Menu', 'talkingbusiness_lite' ); ?>
		</button>
		<?php
			$args = apply_filters( 'talkingbusiness_lite_main_menu_args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'talkingbusiness_lite_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'talkingbusiness_lite' ),
			) );
 ...
 * @return void
 */
function talkingbusiness_lite_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'talkingbusiness_lite_footer_menu_args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'talkingbusiness_lite' ),
		) );
 ...
 * @return void
 */
function talkingbusiness_lite_top_menu() {
 ...
 * @return string
 */
function talkingbusiness_lite_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'talkingbusiness_lite_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'talkingbusiness_lite_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'talkingbusiness_lite' ),
	), $context, $type );
 ...
 * @return void
 */
function talkingbusiness_lite_set_nav_menu( $args ) {
